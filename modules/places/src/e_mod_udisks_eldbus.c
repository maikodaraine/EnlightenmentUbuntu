...
static void
_places_udisks_enumerate_devices_cb(void *data, const Eldbus_Message *msg, Eldbus_Pending *pending)
{
...
static void
_places_udisks_device_add_cb(void *data, const Eldbus_Message *msg)
{
   Volume *vol;
   char *devpath;
...
static void
_places_udisks_device_del_cb(void *data, const Eldbus_Message *msg)
{
   Volume *vol;
   char *devpath;
...
static void
_places_udisks_vol_props_cb(void *data, const Eldbus_Message *msg, Eldbus_Pending *pending)
{
   Volume *vol = data;
